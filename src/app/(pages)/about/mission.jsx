            ...
            <div className="section-wrapper">
                <div className="mt-block grid md:grid-cols-7 gap-block">
                    <div className="md:col-span-4">
                        <FadeUp tag="h2" className="text-left text-2xl md:text-3xl">
                            My mission is to build websites that users love, appreciate, and understand, helping to grow your business.
                        </FadeUp>
                        <FadeUp tag="p">
                            <i>I&apos;m Salman Mallick. I love creating effective and beautiful websites that its users love to visit, subconsciously appreciate and understand easily, helping your business reach new heights.</i>
                        </FadeUp>

                        <FadeUp tag="p" className="mt-xs">
                    ...
                    <div className="relative w-full md:col-span-3">
                        <FadeLeft className="sticky top-block w-full">
